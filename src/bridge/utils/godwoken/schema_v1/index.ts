function dataLengthError(actual: any, required: string | number) {
    throw new Error(`Invalid data length! Required: ${required}, actual: ${actual}`);
}

function assertDataLength(actual: number, required: string | number) {
  if (actual !== required) {
    dataLengthError(actual, required);
  }
}

function assertArrayBuffer(reader: { toArrayBuffer: () => any; }) {
...
function verifyAndExtractOffsets(view: { byteLength: number; getUint32: (arg0: number, arg1: boolean) => any; }, expectedFieldCount: number, compatible: boolean) {
...
function serializeTable(buffers: string | any[]) {
...
export class Uint32Vec {
  view: DataView;
  constructor(reader: any, { validate = true } = {}) {
...
export function SerializeUint32Vec(value: string | any[]) {
...
export function SerializeBlockMerkleState(value: { merkle_root: any; count: any; }) {
...
export function SerializeAccountMerkleState(value: { merkle_root: any; count: any; }) {
...
export function SerializeGlobalStateV0(value: { rollup_config_hash: any; account: any; block: any; reverted_block_root: any; tip_block_hash: any; last_finalized_block_number: any; status: number; }) {
...
export function SerializeGlobalState(value: { rollup_config_hash: any; account: any; block: any; reverted_block_root: any; tip_block_hash: any; tip_block_timestamp: any; last_finalized_block_number: any; status: number; version: number; }) {
...
export function SerializeAllowedTypeHash(value: { type_: number; hash: any; }) {
...
export function SerializeAllowedTypeHashVec(value: string | any[]) {
...
export function SerializeRollupConfig(value: { l1_sudt_script_type_hash: any; custodian_script_type_hash: any; deposit_script_type_hash: any; withdrawal_script_type_hash: any; challenge_script_type_hash: any; stake_script_type_hash: any; l2_sudt_validator_script_type_hash: any; burn_lock_hash: any; required_staking_capacity: any; challenge_maturity_blocks: any; finality_blocks: any; reward_burn_rate: number; compatible_chain_id: any; allowed_eoa_type_hashes: any; allowed_contract_type_hashes: any; }) {
  const buffers = [];
...
export function SerializeRawL2Transaction(value: { from_id: any; to_id: any; nonce: any; args: any; }) {
  const buffers = [];
...
export function SerializeL2Transaction(value: { raw: any; signature: any; }) {
  const buffers = [];
...
export function SerializeL2TransactionVec(value: any[]) {
  return serializeTable(value.map((item: any) => SerializeL2Transaction(item)));
}
...
export function SerializeSubmitTransactions(value: { tx_witness_root: any; tx_count: any; prev_state_checkpoint: any; }) {
...
export function SerializeSubmitWithdrawals(value: { withdrawal_witness_root: any; withdrawal_count: any; }) {
  const array = new Uint8Array(0 + Byte32.size() + Uint32.size());
  const view = new DataView(array.buffer);
...
export function SerializeRawL2Block(value: { number: any; block_producer_id: any; parent_block_hash: any; stake_cell_owner_lock_hash: any; timestamp: any; prev_account: any; post_account: any; state_checkpoint_list: any; submit_withdrawals: any; submit_transactions: any; }) {
  const buffers = [];
...
export function SerializeRawL2BlockVec(value: any[]) {
  return serializeTable(value.map((item: any) => SerializeRawL2Block(item)));
}
...
export function SerializeL2Block(value: { raw: any; kv_state: any; kv_state_proof: any; transactions: any; block_proof: any; withdrawals: any; }) {
  const buffers = [];
...
export function SerializeDepositRequest(value: { capacity: any; amount: any; sudt_script_hash: any; script: any; }) {
  const buffers = [];
...
export function SerializeDepositRequestVec(value: any[]) {
  return serializeTable(value.map((item: any) => SerializeDepositRequest(item)));
}
...
export function SerializeRawWithdrawalRequestV1(value: { nonce: any; chain_id: any; capacity: any; amount: any; sudt_script_hash: any; account_script_hash: any; owner_lock_hash: any; fee: any; }) {
...
export function SerializeWithdrawalRequestVec(value: any[]) {
  return serializeTable(value.map((item: any) => SerializeWithdrawalRequest(item)));
}
...
export function SerializeWithdrawalRequest(value: { raw: any; signature: any; }) {
  const buffers = [];
...
export function SerializeWithdrawalRequestExtra(value: { request: any; owner_lock: any; }) {
  const buffers = [];
...
export function SerializeKVPair(value: { k: any; v: any; }) {
...
export function SerializeKVPairVec(value: string | any[]) {
...
export function SerializeBlockInfo(value: { block_producer_id: any; number: any; timestamp: any; }) {
...
export function SerializeDepositLockArgs(value: { owner_lock_hash: any; layer2_lock: any; cancel_timeout: any; }) {
  const buffers = [];
...
export function SerializeCustodianLockArgs(value: { deposit_lock_args: any; deposit_block_hash: any; deposit_block_number: any; }) {
  const buffers = [];
...
export function SerializeUnlockCustodianViaRevertWitness(value: { deposit_lock_hash: any; }) {
...
export function SerializeWithdrawalLockArgs(value: { withdrawal_block_hash: any; withdrawal_block_number: any; account_script_hash: any; owner_lock_hash: any; }) {
...
export function SerializeUnlockWithdrawalWitness(value: { type: any; value: any; }) {
  switch (value.type) {
...
export function SerializeUnlockWithdrawalViaFinalize(value: any) {
  const buffers: never[] = [];
  return serializeTable(buffers);
}
...
export function SerializeUnlockWithdrawalViaRevert(value: { custodian_lock_hash: any; }) {
  const array = new Uint8Array(0 + Byte32.size());
  const view = new DataView(array.buffer);
...
export function SerializeStakeLockArgs(value: { owner_lock_hash: any; stake_block_number: any; }) {
  const array = new Uint8Array(0 + Byte32.size() + Uint64.size());
  const view = new DataView(array.buffer);
...
export function SerializeMetaContractArgs(value: { type: any; value: any; }) {
  switch (value.type) {
  case "CreateAccount":
    {
...
export function SerializeCreateAccount(value: { script: any; fee: any; }) {
  const buffers = [];
  buffers.push(SerializeScript(value.script));
...
export function SerializeSUDTArgs(value: { type: any; value: any; }) {
  switch (value.type) {
  case "SUDTQuery":
    {
...
export function SerializeSUDTQuery(value: { short_script_hash: any; }) {
  const buffers = [];
...
export function SerializeSUDTTransfer(value: { to: any; amount: any; fee: any; }) {
  const buffers = [];
...
export function SerializeChallengeTarget(value: { block_hash: any; target_index: any; target_type: number; }) {
...
export function SerializeChallengeLockArgs(value: { target: any; rewards_receiver_lock: any; }) {
  const buffers = [];
...
export function SerializeChallengeWitness(value: { raw_l2block: any; block_proof: any; }) {
  const buffers = [];
...
export function SerializeScriptVec(value: any[]) {
  return serializeTable(value.map((item: any) => SerializeScript(item)));
}
...
export function SerializeBlockHashEntry(value: { number: any; hash: any; }) {
...
export function SerializeBlockHashEntryVec(value: string | any[]) {
...
export function SerializeCKBMerkleProof(value: { indices: any; lemmas: any; }) {
  const buffers = [];
...
export function SerializeCCTransactionWitness(value: { l2tx: any; raw_l2block: any; tx_proof: any; kv_state_proof: any; block_hashes_proof: any; account_count: any; kv_state: any; load_data: any; scripts: any; return_data_hash: any; block_hashes: any; }) {
  const buffers = [];
...
export function SerializeCCTransactionSignatureWitness(value: { raw_l2block: any; l2tx: any; tx_proof: any; kv_state: any; kv_state_proof: any; account_count: any; sender: any; receiver: any; }) {
  const buffers = [];
  buffers.push(SerializeRawL2Block(value.raw_l2block));
  buffers.push(SerializeL2Transaction(value.l2tx));
  buffers.push(SerializeCKBMerkleProof(value.tx_proof));
...
export function SerializeCCWithdrawalWitness(value: { raw_l2block: any; withdrawal: any; sender: any; owner_lock: any; withdrawal_proof: any; }) {
  const buffers = [];
  buffers.push(SerializeRawL2Block(value.raw_l2block));
...
export function SerializeRollupSubmitBlock(value: { block: any; reverted_block_hashes: any; reverted_block_proof: any; }) {
  const buffers = [];
...
export function SerializeRollupEnterChallenge(value: { witness: any; }) {
  const buffers = [];
...
export function SerializeRollupCancelChallenge(value: any) {
  const buffers: never[] = [];
  return serializeTable(buffers);
}
...
export function SerializeRollupRevert(value: { reverted_blocks: any; block_proof: any; reverted_block_proof: any; new_tip_block: any; }) {
  const buffers = [];
...
export function SerializeRollupAction(value: { type: any; value: any; }) {
  switch (value.type) {
...
export function SerializeByte20(value: any) {
...
export function SerializeETHAddrRegArgs(value: { type: any; value: any; }) {
  switch (value.type) {
  case "EthToGw":
    {
...
export function SerializeEthToGw(value: { eth_address: any; }) {
...
export function SerializeGwToEth(value: { gw_script_hash: any; }) {
  const array = new Uint8Array(0 + Byte32.size());
  const view = new DataView(array.buffer);
...
export function SerializeSetMapping(value: { gw_script_hash: any; fee: any; }) {
  const array = new Uint8Array(0 + Byte32.size() + Uint64.size());
  const view = new DataView(array.buffer);
  array.set(new Uint8Array(SerializeByte32(value.gw_script_hash)), 0);
...
export function SerializeBatchSetMapping(value: { gw_script_hashes: any; fee: any; }) {
  const buffers = [];
...
export function SerializeUint16(value: any) {
  const buffer = assertArrayBuffer(value);
...
export function SerializeUint32(value: any) {
  const buffer = assertArrayBuffer(value);
...
export function SerializeUint128(value: any) {
  const buffer = assertArrayBuffer(value);
...
export function SerializeUint256(value: any) {
  const buffer = assertArrayBuffer(value);
  assertDataLength(buffer.byteLength, 32);
  return buffer;
}
...
export function SerializeBytesOpt(value: any) {
  if (value) {
...
export function SerializeBytesVec(value: any[]) {
  return serializeTable(value.map((item: any) => SerializeBytes(item)));
}
...
export function SerializeByte32Vec(value: string | any[]) {
...
export function SerializeScriptOpt(value: any) {
  if (value) {
...
export function SerializeProposalShortId(value: any) {
  const buffer = assertArrayBuffer(value);
...
export function SerializeUncleBlockVec(value: any[]) {
  return serializeTable(value.map((item: any) => SerializeUncleBlock(item)));
}
...
export function SerializeTransactionVec(value: any[]) {
  return serializeTable(value.map((item: any) => SerializeTransaction(item)));
}
...
export function SerializeProposalShortIdVec(value: string | any[]) {
...
export function SerializeCellDepVec(value: string | any[]) {
...
export function SerializeCellInputVec(value: string | any[]) {
...
export function SerializeCellOutputVec(value: any[]) {
  return serializeTable(value.map((item: any) => SerializeCellOutput(item)));
}
...
export function SerializeScript(value: { code_hash: any; hash_type: number; args: any; }) {
  const buffers = [];
...
export function SerializeOutPoint(value: { tx_hash: any; index: any; }) {
  const array = new Uint8Array(0 + Byte32.size() + Uint32.size());
  const view = new DataView(array.buffer);
...
export function SerializeCellInput(value: { since: any; previous_output: any; }) {
...
export function SerializeCellOutput(value: { capacity: any; lock: any; type_: any; }) {
  const buffers = [];
  buffers.push(SerializeUint64(value.capacity));
...
export function SerializeCellDep(value: { out_point: any; dep_type: number; }) {
...
export function SerializeRawTransaction(value: { version: any; cell_deps: any; header_deps: any; inputs: any; outputs: any; outputs_data: any; }) {
  const buffers = [];
...
export function SerializeTransaction(value: { raw: any; witnesses: any; }) {
  const buffers = [];
...
export function SerializeRawHeader(value: { version: any; compact_target: any; timestamp: any; number: any; epoch: any; parent_hash: any; transactions_root: any; proposals_hash: any; extra_hash: any; dao: any; }) {
...
export function SerializeHeader(value: { raw: any; nonce: any; }) {
...
export function SerializeUncleBlock(value: { header: any; proposals: any; }) {
  const buffers = [];
...
export function SerializeBlock(value: { header: any; uncles: any; transactions: any; proposals: any; }) {
  const buffers = [];
  buffers.push(SerializeHeader(value.header));
...
export function SerializeBlockV1(value: { header: any; uncles: any; transactions: any; proposals: any; extension: any; }) {
  const buffers = [];
  buffers.push(SerializeHeader(value.header));
  buffers.push(SerializeUncleBlockVec(value.uncles));
  buffers.push(SerializeTransactionVec(value.transactions));
...
export function SerializeCellbaseWitness(value: { lock: any; message: any; }) {
  const buffers = [];
  buffers.push(SerializeScript(value.lock));
...
export function SerializeWitnessArgs(value: { lock: any; input_type: any; output_type: any; }) {
  const buffers = [];
