...
describe('AddressTranslator', () => {
    ...
    test('getLayer2DepositAddress() correctly calculates Layer 2 deposit address secured by Omni Lock on Layer 1', async () => {
        ...
        expect(omniLockLayer2DepositAddress).toBe('');
    });
});
